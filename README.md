...
The objective of this project is to explore how job characteristics—such as job title, location, work type, experience level, company, and other posting attributes—can be used to estimate annual salary. Throughout this project, I focus on building a complete machine learning workflow, including data cleaning, exploratory data analysis, feature engineering, model development, and evaluation.
...
- Natural language processing (NLP) using job descriptions
